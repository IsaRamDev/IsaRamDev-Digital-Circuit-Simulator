  ...
  return (
    <div>
      <svg width="120" height="60" viewBox="0 0 120 60" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="20" cy="30" r="3" fill="black" onClick={() => handleConnectionPointClick('input')} />
        <circle cx="20" cy="50" r="3" fill="black" onClick={() => handleConnectionPointClick('input2')} />
        <circle cx="100" cy="40" r="3" fill={"black"} onClick={() => handleConnectionPointClick('output')} />
